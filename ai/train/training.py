...
from ai.utils.iterative_mean import Mean
from ai.dataset import WBDataset
from ai.train.logger import Logger
from ai.train.checkpoint import CheckPoint
from ai.train.predictions import Predictions
from ai.train.metrics_collection import MetricsCollection
from ai.train.models import get_model
...
class Training:
    ...
    def _create_model(self, dataset):
        model = get_model(
    ...
    def __tqdm_loop(self, function):
        ...
        def new_function(epoch, loader, description, mean: Mean):
            ...
            metrics = MetricsCollection(dataset.output_size, self.device)
    ...
    def find_lr(self, train_loader):
        ...
        self.model = self._create_model(train_dataset)
    ...
    def predict(self, loader, run_id):
        ...
        self.model = self._create_model(dataset)
